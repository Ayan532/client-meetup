...
import { changePassword, LoadUser } from '../../../Redux/Action/AuthAction'
     ...
     <VStack h={"75vh"} borderRadius={"20"} p={"8"} width="600px" justifyContent={"center"}  spacing={"10"} boxShadow="0px 5px 8px #00000029">
      ...
      onSubmit={handleSubmit}
       style={{width: '100%'}}>
        ...
        <Button my="5" mb="5" isLoading={loading} colorScheme='red' width={"full"} type={"submit"}>Change Password</Button>
