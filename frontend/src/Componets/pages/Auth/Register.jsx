import { Avatar, background, Box, Button, Container, Divider, Flex, FormLabel, Heading, Input, Select, VStack } from '@chakra-ui/react'
...
const Register = () => {
  ...
  return (
    <Flex  h={"100vh"} p={{sm:"10px",md:"10px",lg:"5px"}} justifyContent="center"  alignItems="center">
    <VStack h={{md:"100vh",lg:"95vh"}} p={{sm:"20px",md:"20px",lg:"30x"}} borderRadius={"20"} width="600px" justifyContent={"center"}  boxShadow="0px 3px 6px #00000029" spacing={"5"}>
       <Heading>
         REGISTRATION
       </Heading>
       <Divider />
       ...
       <Box my={'2'} width={"100%"}>
        ...
        <Button my="2" colorScheme='red' width={"full"} type={"submit"}>Sign Up</Button>
        <Box>
        Already Signed Up?{' '}
        <Link to="/login">
